    ...
    const handleClickUAddBtn = () => {
        if(!isAddMode){
            ...
            setStudentDetail({
                ...
                schoolNum : "",
                scores : [
                    {semester:"1학년 1학기", score:null},
                    {semester:"1학년 2학기", score:null},
                    {semester:"1학년 2학기", score:null},
                    {semester:"2학년 1학기", score:null},
                    {semester:"2학년 2학기", score:null},
                    {semester:"3학년 1학기", score:null},
                    {semester:"3학년 2학기", score:null},
                    {semester:"4학년 1학기", score:null},
                    {semester:"4학년 2학기", score:null},
                ]
            })
        }else{
            // studentRequest 상태를 서버에다가 수정 요청으로 보낸다.
    ...
    return <div className={"container"}>
        <div className={"detail-container"}>
            <div className={"btn-container"}>
                ...
                <button className={"btn btn-add"} onClick={handleClickUAddBtn}>추가</button>
            </div>
            <StudentDetail detailInfo={studentDetail} editMode={isEditMode} addMode={isAddMode} schoolList={schoolList} setStudentRequest={setStudentRequest}/>
        </div>
